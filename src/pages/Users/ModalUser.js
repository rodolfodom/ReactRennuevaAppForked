...
function ModalUser({ children, mode }) {
  ...
  useEffect(() => {
    ...
    const fetchGroups = axios.get('https://api.rennueva.com/Rennueva/get-all-groups/');
    const fetchUsers = axios.post('https://api.rennueva.com/Rennueva/get-all-users/', { group: "Administrador" });
