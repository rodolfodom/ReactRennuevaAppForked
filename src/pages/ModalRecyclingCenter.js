...
function ModalRecyclingCenter({ children, mode }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (mode === "CREAR") {
            ...
            axios
                .post('http://10.10.200.12:8008/Rennueva/create-recycling-center/', nuevoDato)
                .then(response => {
        ...
        if (mode === "EDITAR") {
            ...
            axios
                .post('http://10.10.200.12:8008/Rennueva/update-recycling-center/', editarDato)
                .then(response => {
                    const data = response.data;
                    console.log(data)
                    setOpenModalText(true);
        ...
        if (mode === "BORRAR") {
            ...
            axios
                .post('http://10.10.200.12:8008/Rennueva/delete-recycling-center/', deleteDato)
                .then(response => {
                    const data = response.data;
                    console.log(data)
                    setOpenModalText(true);
    ...
    useEffect(() => {
        const fetchUsers = axios.get("http://10.10.200.12:8008/Rennueva/get-all-recycling-center/")
