...
function ModalCollectionCenter({ children, mode }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (mode === "CREAR") {
            ...
            axios
                .post('http://10.10.200.12:8008/Rennueva/create-collection-center/', nuevoDato)
                .then(response => {
        ...
        if (mode === "EDITAR") {
            ...
            axios
                .post('http://10.10.200.12:8008/Rennueva/update-collection-center/', editarDato)
                .then(response => {
                    const data = response.data;
                    console.log(data)
                    setOpenModalText(true);
        ...
        if (mode === "BORRAR") {
            ...
            axios
                .post('http://10.10.200.12:8008/Rennueva/delete-collection-center/', deleteDato)
                .then(response => {
                    const data = response.data;
                    console.log(data)
                    setOpenModalText(true);
    ...
    useEffect(() => {
        const fetchUsers = axios.get("http://10.10.200.12:8008/Rennueva/get-all-collection-center/")
