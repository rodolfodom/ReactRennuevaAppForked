...
function ModalReport({ children, mode }) {
    ...
    useEffect(() => {
        axios
            .get('http://10.10.200.12:8008/Rennueva/get-all-users-responsiva/')
            .then(response => {
    ...
    useEffect(() => {
        axios
            .get('http://10.10.200.12:8008/Rennueva/get-all-carrier/')
            .then(response => {
                const data = response.data;
    ...
    useEffect(() => {
        axios
            .get('http://10.10.200.12:8008/Rennueva/get-all-recycling-collection-center/')
            .then(response => {
                const data = response.data;
                console.log("#############################CARRIERS#######################")
                console.log(data)
    ...
    const handleSubmit = (e) => {
        ...
        if (mode === "CREAR") {
            ...
            axios
                .post('http://10.10.200.12:8008/Rennueva/create-initial-report/', {
                    username: user,
                    street: street,
                    locality: locality,
                    city: city,
