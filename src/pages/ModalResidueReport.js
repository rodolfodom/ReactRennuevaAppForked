...
function ModalResidueReport({ onClose, userselect, report }) { // Asegúrate de manejar el evento de cierre adecuadamente
    ...
    useEffect(() => {
        ...
        // const fetchResidues = axios.get('http://10.10.200.12:8008/Rennueva/get-all-residue/');
        // const fetchReportResidues = axios.post('http://10.10.200.12:8008/Rennueva/get-all-residues-per-report/', "14");
        ...
        axios.get('http://10.10.200.12:8008/Rennueva/get-all-residue/')
            .then(response => {
        ...
        axios.post('http://10.10.200.12:8008/Rennueva/get-all-residues-per-report/', getResidues)
            .then(response => {
                const data = response.data;
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post('http://10.10.200.12:8008/Rennueva/create-report-residue-user/', entries)
            .then(response => {
                const data = response.data;
                console.log(data)
