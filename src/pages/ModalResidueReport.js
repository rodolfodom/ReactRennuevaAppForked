...
function ModalResidueReport({ onClose, userselect, report }) { // Asegúrate de manejar el evento de cierre adecuadamente
    ...
    useEffect(() => {
        ...
        // const fetchResidues = axios.get('https://api.rennueva.com/Rennueva/get-all-residue/');
        // const fetchReportResidues = axios.post('https://api.rennueva.com/Rennueva/get-all-residues-per-report/', "14");
        ...
        axios.get('https://api.rennueva.com/Rennueva/get-all-residue/')
            .then(response => {
        ...
        axios.post('https://api.rennueva.com/Rennueva/get-all-residues-per-report/', getResidues)
            .then(response => {
                const data = response.data;
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post('https://api.rennueva.com/Rennueva/create-report-residue-user/', entries)
            .then(response => {
                const data = response.data;
                console.log(data)
